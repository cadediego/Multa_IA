...
def extrair_dados_da_imagem(image_bytes):
    ...
    """
    try:
        # Enviar a imagem para o GPT Vision
        ...
        if response and "text" in response:
            ...
            # Agora que temos o texto extraído, pedimos para o GPT analisar e estruturar os dados
            prompt = f"""
...
# Exemplo de uso (em uma aplicação Streamlit ou qualquer outro lugar)
def processar_imagem(uploaded_file):
    ...
    # Chama a função para extrair dados
